...
/// <summary>
/// <para>Contains method signatures for retrieving random entities from a given source.</para>
...
public interface IRandomDataAccessor
{
    ...
    /// <summary>
    /// Retrieve a subset of size <paramref name="numberOfEntitiesToRetrieve"/> of random <typeparamref name="T"/> entities
    /// </summary>
    /// <typeparam name="T"></typeparam>

...
/// <summary>
/// <para>Contains method signatures for retrieving random entities from a provided source.</para>
...
public interface ISourcedRandomDataAccessor
{
    ...
    /// <summary>
    /// Retrieve a subset of size <paramref name="numberOfEntitiesToRetrieve"/> of random <typeparamref name="T"/> entities from the given <paramref name="source"/>
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    /// <returns>A moderately randomized subset of entities</returns>
    ...
    /// <typeparam name="T"></typeparam>
    /// <param name="numberOfEntitiesToRetrieve">The number of entities we want to populate randomly</param>
    /// <param name="source">The provided asynchronous stream of entities</param>
    /// <param name="cancellationToken"></param>
